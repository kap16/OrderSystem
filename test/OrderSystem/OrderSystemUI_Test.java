 ...
 */
public class OrderSystemUI_Test extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pipesRUs.setText("Pipe's R US - Order System - TESTING VERSION");
...
orderSummaryPanelLayout.setHorizontalGroup(
    ...
    layout.setHorizontalGroup(
        ...
        .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
            .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
            .addComponent(pipesRUs, javax.swing.GroupLayout.PREFERRED_SIZE, 339, javax.swing.GroupLayout.PREFERRED_SIZE)
            .addGap(325, 325, 325))
    );
    ...
    ArrayList<Test_Pipe> pipes = new ArrayList<>();
        ...
        public void valueChanged(ListSelectionEvent e) {
            if (pipes.size() > 0 && !e.getValueIsAdjusting()) {
                ...
                if (pipeList.isSelectionEmpty() || pipes.isEmpty()) {
                    ...
                    Test_Pipe pipeSelected = pipes.get(selected);
                    pipeDetailsLabel.setText("<html>Length: " + pipeSelected.getLength()
                            ...
                            + "<br>Used Type: " + pipeSelected.getType().toUpperCase()
                            + "</html>");
                }
        ...
        if (pass == false) {
            ...
            for (int i = 0; i < Double.parseDouble(amountAsString); i++) {
                ...
                if (grade >= 3 && inSu == true && reIn == true
                        && noOfColours >= 0) {
                    Test_TypeV newPipe = new Test_TypeV(l, d, grade, inSu, reIn, chemRes);
                    ...
                    dlm.addElement(newPipe.getLabel());
                        ...
                        && noOfColours >= 0) {
                    Test_TypeIV newPipe = new Test_TypeIV(l, d, grade, inSu, reIn, chemRes);
                    newPipe.setLabel(tempName);
                    pipes.add(newPipe);
                    dlm.addElement(newPipe.getLabel());
                } // Type III
                        ...
                        && noOfColours >= 0) {
                    Test_TypeIII newPipe = new Test_TypeIII(l, d, grade, inSu, reIn, chemRes);
                    newPipe.setLabel(tempName);
                    pipes.add(newPipe);
                    dlm.addElement(newPipe.getLabel());
                } // Type II
                else if (4 >= grade && grade >= 2 && inSu == false && reIn == false
                        && (noOfColours == 1 || noOfColours == 0)) {
                    Test_TypeII newPipe = new Test_TypeII(l, d, grade, inSu, reIn, chemRes);
                    newPipe.setLabel(tempName);
                    pipes.add(newPipe);
                    dlm.addElement(newPipe.getLabel());
                } // Type I
                        ...
                        && noOfColours == 0) {
                    Test_TypeI newPipe = new Test_TypeI(l, d, grade, inSu, reIn, chemRes);
                    newPipe.setLabel(tempName);
                    pipes.add(newPipe);
                    dlm.addElement(newPipe.getLabel());
                } else {
    ...
    private void quoteButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_quoteButtonActionPerformed
        if (customerNameTextField.getText().isEmpty()) {
            ...
            for (int i = 0; i < pipes.size(); i++) {
                Test_Pipe currPipe = pipes.get(i);
                order.append("\n============" + currPipe.getLabel() + "============"
    ...
    private double totalCost() {
        ...
        if (pipes.size() > 0) {
            for (int i = 0; i < pipes.size(); i++) {
                Test_Pipe currentPipe = pipes.get(i);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(OrderSystemUI_Test.class
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            @Override
            public void run() {
                new OrderSystemUI_Test().setVisible(true);
            }
        });
    }
