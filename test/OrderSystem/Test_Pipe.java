...
public abstract class Test_Pipe{
    ...
    /* 
     *Creates a new instance of Test_Pipe 
     */
    public Test_Pipe() {
    }

    /**
     * Constructs a new Test_Pipe
     ...
     */
    public Test_Pipe(double length, double diameter, int grade,
    ...
    /**
     * @return the type of pipe used (for testing purposes only)
     */
