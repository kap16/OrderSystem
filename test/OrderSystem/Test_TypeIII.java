 ...
 * @author up720776
 */
public class Test_TypeIII extends Test_Pipe {

    /* 
     * Creates a new instance of Type 3 Test_Pipe 
     *
    public Test_TypeIII() {
    }

    /**
     * Constructs a new Type 3 Test_Pipe
     ...
     */
    public Test_TypeIII(double length, double diameter, int grade,
