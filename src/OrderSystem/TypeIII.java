 ...
 * @author up720776
 */
public class TypeIII extends Pipe {

    /* 
     * Creates a new instance of Type 3 Pipe 
     *
    public TypeIII() {
    }

    /**
     * Constructs a new Type 3 Pipe
     ...
     */
    public TypeIII(double length, double diameter, int grade,
